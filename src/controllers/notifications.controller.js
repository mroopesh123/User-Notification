...
var NotificationsController = function () {
    ...
    var _sendNotification_decorators;
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.sendNotification = function (sendDto) {
            return this.notificationsService.send(sendDto);
        };
        NotificationsController_1.prototype.getLogs = function (userId) {
            return this.notificationsService.getLogs(userId);
        };
        NotificationsController_1.prototype.getStats = function () {
    ...
    (function () {
        ...
        _sendNotification_decorators = [(0, common_1.Post)('send')];
        _getLogs_decorators = [(0, common_1.Get)(':userId/logs')];
        _getStats_decorators = [(0, common_1.Get)('stats')];
        __esDecorate(_classThis, null, _sendNotification_decorators, { kind: "method", name: "sendNotification", static: false, private: false, access: { has: function (obj) { return "sendNotification" in obj; }, get: function (obj) { return obj.sendNotification; } }, metadata: _metadata }, null, _instanceExtraInitializers);
